...
/// "erc777" is not mentioned here intentionally as the functionality is not compatible with ERC777
/// token standard.
...
impl TestToken {
    pub fn install() -> Result<TestToken, Error> {
        ...
        let granularity = TOKEN_GRANULARITY;
        ...
        entry_points.add_entry_point(casper_erc777::entry_points::total_supply());
        entry_points.add_entry_point(casper_erc777::entry_points::balance_of());
        ...
        // described by ERC777 token standard.
        //
        // This is unsafe and this test contract is not a ERC777 token standard-compliant token.
        // Contract developers should use example/erc777 contract instead as a template for writing
        // their own tokens.
        let erc777 = ERC777::install_custom(
            name,
            symbol,
            decimals,
            granularity,
